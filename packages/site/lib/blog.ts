...
export const BLOG_POSTS: BlogPostMeta[] = [
  {
    ...
    keywords: [
      ...
      'iPhone Duo app development',
      'foldable iPhone web app',
      'Capacitor foldable layout',
  ...
  {
    slug: 'android-developer-verification-capacitor',
    title: 'Android developer verification: what Capacitor teams must do by 30 September',
    seoTitle: 'Android Developer Verification Deadline (30 Sept 2026): A Capacitor Checklist',
    description:
    ...
    keywords: [
      ...
      'Android sideloading 2026',
      'Android Developer Console registration',
      'Capacitor Android verification',
      'register package name Android',
    ],
    order: 104,
    relatedDocs: [
      { href: '/docs/channels', label: 'Channels & runtime version' },
  ...
  {
    slug: 'google-play-app-optimization-below-threshold-capacitor',
    title: 'Fix “App optimization is below our threshold” in a Capacitor app',
    seoTitle: 'Google Play Obfuscation Below 25%: Fix It in Capacitor With R8',
    description:
    ...
    keywords: [
      ...
      'Google Play obfuscation 25%',
      'R8 Capacitor',
      'Capacitor minifyEnabled',
      'Play Console obfuscation warning',
      'Google Play February 2027 requirements',
    ],
    order: 105,
    relatedDocs: [
      { href: '/docs/ci', label: 'CI/CD' },
  ...
  },
  {
    ...
    readingTime: '7 min read',
    keywords: [
      'Apple EU App Store changes October 2026',
      'Core Technology Commission',
      'Core Technology Fee replaced',
      'Apple EU link-out commission',
      'Apple alternative payments EU',
      'DMA App Store fees 2026',
    ],
    order: 106,
    relatedDocs: [
      { href: '/docs/channels', label: 'Channels & runtime version' },
  ...
  {
    slug: 'sign-in-with-apple-private-icloud-domain',
    title: 'Sign in with Apple moves to private.icloud.com: check your backend',
    seoTitle: 'Sign in with Apple New Relay Domain: private.icloud.com (2026)',
    description:
    ...
    keywords: [
      ...
      'Sign in with Apple relay email',
      'Sign in with Apple new domain',
  ...
  {
    slug: 'ios-27-sdk-requirement-april-2027',
    title: 'The iOS 27 SDK becomes mandatory in April 2027',
    seoTitle: 'iOS 27 SDK Required From April 2027: Plan for Capacitor Apps',
    description:
    ...
    keywords: [
      'iOS 27 SDK requirement',
      'App Store minimum SDK April 2027',
  ...
  {
    slug: 'best-ci-cd-platforms-for-capacitor-apps',
    title: 'The best CI/CD platforms for Capacitor apps in 2026',
    seoTitle: 'Best CI/CD for Capacitor Apps (2026): GitHub Actions vs Codemagic vs Bitrise',
    description:
    ...
    keywords: [
      'Capacitor CI/CD',
      'best CI/CD for Capacitor',
      'Codemagic Capacitor',
      'Bitrise Capacitor',
      'GitHub Actions Capacitor',
      'Appflow build alternative',
    ],
    order: 109,
    relatedDocs: [
      { href: '/docs/ci', label: 'CI/CD' },
  ...
  {
    slug: 'capacitor-in-app-review-prompt',
    title: 'Ask for App Store and Google Play ratings in a Capacitor app',
    seoTitle: 'Capacitor In-App Review: Get More App Store Ratings (2026 Guide)',
    description:
    ...
    keywords: [
      ...
      'Capacitor rate app',
      'SKStoreReviewController Capacitor',
      'Google Play in-app review Capacitor',
      'increase app store ratings',
      'app review prompt best practices',
    ],
    order: 110,
    relatedDocs: [
  ...
  {
    slug: 'stripe-payments-capacitor-app-store-rules',
    title: 'Can a Capacitor app use Stripe? Apple and Google payment rules in 2026',
    seoTitle: 'Stripe in a Capacitor App: What Apple and Google Allow in 2026',
    description:
    ...
    keywords: [
      'Stripe Capacitor',
      'Capacitor Stripe payments',
      'Apple external payment link 2026',
      'App Store anti-steering ruling',
      'in-app purchase vs Stripe',
      'Capacitor web checkout',
    ],
    order: 111,
    relatedDocs: [
      { href: '/docs/channels', label: 'Channels & runtime version' },
  ...
  {
    slug: 'sentry-capacitor-ota-source-maps',
    title: 'Sentry for Capacitor apps with OTA updates',
    seoTitle: 'Sentry + Capacitor: Readable Stack Traces With OTA Updates',
    description:
      'Set up Sentry in a Capacitor app so every error maps to the exact OTA bundle that caused it: releases, debug IDs, source maps that never ship to devices, and rollback alerts.',
    category: 'Guides',
    publishedAt: '2026-09-23',
    readingTime: '8 min read',
    keywords: [
      'Sentry Capacitor',
      'Capacitor source maps',
      'Capacitor crash reporting',
      '@sentry/capacitor setup',
      'OTA update error tracking',
      'Sentry release per bundle',
    ],
    order: 112,
    relatedDocs: [
      { href: '/docs/events', label: 'Events' },
  ...
  {
    slug: 'apple-foundation-models-capacitor',
    title: 'On-device AI in a Capacitor app with Apple Foundation Models',
    seoTitle: 'Apple Foundation Models in Capacitor: On-Device AI Plugin Tutorial',
    description:
    ...
    readingTime: '9 min read',
    keywords: [
      'Apple Foundation Models Capacitor',
      'on-device AI Capacitor',
      'Capacitor LLM plugin',
      'FoundationModels framework tutorial',
      'Apple Intelligence Capacitor',
  ...
  {
    slug: 'remove-cordova-plugins-capacitor-9',
    title: 'Go Cordova-free before Capacitor 9',
    seoTitle: 'Remove Cordova Plugins From Your Capacitor App (Capacitor 9 Prep)',
    description:
    ...
    readingTime: '8 min read',
    keywords: [
      'remove Cordova plugins Capacitor',
      'Capacitor 9 Cordova optional',
      'Cordova plugin Capacitor equivalent',
      'cordova-plugin-ionic replacement',
      'Capacitor without Cordova',
      'prepare for Capacitor 9',
    ],
    order: 114,
    relatedDocs: [
  ...
  {
    slug: 'capacitor-performance-checklist',
    title: 'Make a Capacitor app feel native: a performance checklist',
    seoTitle: 'Capacitor Performance Checklist: Make Your App Feel Native (2026)',
    description:
    ...
    keywords: [
      ...
      'Capacitor app slow',
      'make Capacitor app feel native',
      'Capacitor startup time',
      'Ionic performance tips',
  ...
  {
    slug: 'how-often-should-you-release-a-mobile-app',
    title: 'How often should you release a mobile app?',
    seoTitle: 'How Often Should You Release a Mobile App? A Release Cadence Guide',
    description:
    ...
    readingTime: '7 min read',
    keywords: [
      'how often to release mobile app',
      'mobile app release cadence',
      'app release frequency',
      'release train mobile',
      'app update frequency best practice',
