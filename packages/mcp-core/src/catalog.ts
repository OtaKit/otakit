...
export const OTAKIT_TOOL_CATALOG: readonly OtaKitToolDefinition[] = [
  ...
  },
  {
    ...
    description:
      'List safe bundle metadata with bounded pagination, optional exact version, and platform/runtime filters for RN apps.',
    modes: both,
    inputSchema: z.object({
  ...
  },
  {
    ...
    inputSchema: z.object({
      ...
      platform: z.enum(['ios', 'android', 'cross']).optional(),
    }),
    annotations: readOnly,
    oauthScopes: ['otakit:read'],
    allowOrganizationKey: true,
