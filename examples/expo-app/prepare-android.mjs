...
if (!output) throw new Error('Usage: node prepare-android.mjs <new directory outside the repo>');
...
if (!name?.startsWith('android-') || others.length) throw new Error('Unexpected export layout');
